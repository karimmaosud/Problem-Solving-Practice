...
public class LargestSumOfAverages {
  static double inf = 1000000000000000.0;
  ...
  private static void initDp(double[][]dp) {
  ...
  private static void initSum(int[] A, int[] sum) {
    sum[0] = A[0];
  ...
  private static double solve(int idx, int[] A, int[] sum, double[][] dp, int k) {
